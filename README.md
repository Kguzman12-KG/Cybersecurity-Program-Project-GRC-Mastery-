...
|-------------|-------------|
| 📄 [Executive Report (PDF)](executive-report/Oscorp_Cybersecurity_Program_Review.pdf) | Full consulting deliverable: current state, roadmap, financial model, NIST summary |
